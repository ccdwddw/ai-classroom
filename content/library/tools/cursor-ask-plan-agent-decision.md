---
title: Cursor 三种模式怎么选：Ask / Plan / Agent 日常决策表
description: 梳理日常任务下 Cursor Ask / Plan / Agent 的选用原则、决策表、五种配方与常见反例，附可复制 Prompt 模板。
author: liuke
date: 2026-09-07
tags:
  - cursor
  ...
  - Agent
category: tools
cover: /assets/cursor-ask-plan-agent-decision/cover.png
coverTone: light
---
...
| 文章 | 回答的问题 |
|------|------------|
| [0 到 1 协作流程](/articles/workflows/ai-zero-to-one-workflow) | 一个新项目怎么从想清楚做到做出来 |
| [Cursor Rules](/articles/tools/cursor-rules) / [Skills](/articles/tools/cursor-skills) | 长期约定与可复用工作流怎么沉淀 |
| [上下文引用实战](/articles/tools/cursor-at-context-guide) | 单次对话里 `@` 该喂什么 |
...
- 站内：[用 AI 从 0 到 1 做一个项目：Ask / Plan / Agent 协作流程](/articles/workflows/ai-zero-to-one-workflow)
- 站内：[Cursor 上下文引用实战](/articles/tools/cursor-at-context-guide)
- 站内：[Cursor Rules：给 Agent 的持久化项目约定](/articles/tools/cursor-rules)
- 站内：[Cursor Skills：查找、安装、创建与常用推荐](/articles/tools/cursor-skills)
- 站内：[VibeCoding — AI 协同开发经验指南](/articles/workflows/vibecoding-guide)
